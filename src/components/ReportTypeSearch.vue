<template>
    <div class="search">
        <input type="text" id="search" name="search" v-model="searchQuery" placeholder="Pesquisar por tipo de denúncia..." @input="searchReportType" @keyup.enter.prevent="searchReportType">
